...
public class RequestGenerator {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException,
        ...
        final String req="<Request xmlns=\"urn:oasis:names:tc:xacml:2.0:context:schema:os\" " +
                ...
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\"><AttributeValue>1003092362</AttributeValue" +
                "></Attribute><Attribute AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject-category:intermediary" +
                "-subject\" DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\"><AttributeValue>1003235045</AttributeValue></Attribute><Attribute " +
                ...
                "DataType=\"http://www.w3.org/2001/XMLSchema#dateTime\"><AttributeValue>2017-06-20T00:38:09.321Z" +
       ...
       */
        ...
        final String xacml= "<?xml version=\"1.0\" encoding=\"UTF-8\"?><PolicySet " +
                "xmlns=\"urn:oasis:names:tc:xacml:2.0:policy:schema:os\"           xmlns:xsi=\"http://www" +
                ".w3.org/2001/XMLSchema-instance\"           " +
                "PolicyCombiningAlgId=\"urn:oasis:names:tc:xacml:1.0:policy-combining-algorithm:deny-overrides\"     " +
                "      PolicySetId=\"b292ec35-fb6e-484c-9105-0baefa680a30\"           " +
                "xsi:schemaLocation=\"urn:oasis:names:tc:xacml:2.0:policy:schema:os http://docs.oasis-open" +
                ".org/xacml/access_control-xacml-2.0-policy-schema-os.xsd\">    <Description/>    <Target/>   <Policy" +
                " PolicyId=\"6OnDlb2hAe\"           " +
                "RuleCombiningAlgId=\"urn:oasis:names:tc:xacml:1.0:rule-combining-algorithm:permit-overrides\">      " +
                "<Description>                          This is a reference policy for                          " +
                "</Description>      <Target/>      <Rule Effect=\"Permit\" RuleId=\"primary-group-rule\">         " +
                "<Target>            <Resources>               <Resource>                  <ResourceMatch " +
                "MatchId=\"urn:oasis:names:tc:xacml:1.0:function:string-equal\">                     <AttributeValue " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">34133-9</AttributeValue>                     " +
                "<ResourceAttributeDesignator AttributeId=\"urn:oasis:names:tc:xacml:1.0:resource:typeCode\"         " +
                "                                         DataType=\"http://www.w3.org/2001/XMLSchema#string\"/>     " +
                "             </ResourceMatch>                  <ResourceMatch " +
                "MatchId=\"urn:oasis:names:tc:xacml:1.0:function:string-equal\">                     <AttributeValue " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">urn:oasis:names:tc:ebxml-regrep:StatusType" +
                ":Approved</AttributeValue>                     <ResourceAttributeDesignator " +
                "AttributeId=\"xacml:status\"                                                  DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\"/>                  </ResourceMatch>               </Resource>       " +
                "     </Resources>            <Actions>               <Action>                  <ActionMatch " +
                "MatchId=\"urn:oasis:names:tc:xacml:1.0:function:string-equal\">                     <AttributeValue " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">xdsquery</AttributeValue>                     " +
                "<ActionAttributeDesignator AttributeId=\"urn:oasis:names:tc:xacml:1.0:action:action-id\"            " +
                "                                    DataType=\"http://www.w3.org/2001/XMLSchema#string\"/>          " +
                "        </ActionMatch>               </Action>               <Action>                  <ActionMatch " +
                "MatchId=\"urn:oasis:names:tc:xacml:1.0:function:string-equal\">                     <AttributeValue " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">xdsretrieve</AttributeValue>                   " +
                "  <ActionAttributeDesignator AttributeId=\"urn:oasis:names:tc:xacml:1.0:action:action-id\"          " +
                "                                      DataType=\"http://www.w3.org/2001/XMLSchema#string\"/>        " +
                ...
                "          </Action>            </Actions>         </Target>         <Condition>            <Apply " +
                ...
                "<SubjectAttributeDesignator AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject-category:intermediary" +
                "-subject\"                                                    DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\"                                                    " +
                "MustBePresent=\"false\"/>                     </Apply>                     <AttributeValue " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">1003235045</AttributeValue>                  " +
                "</Apply>               </Apply>               <Apply " +
                "FunctionId=\"urn:oasis:names:tc:xacml:1.0:function:or\">                  <Apply " +
                "FunctionId=\"urn:oasis:names:tc:xacml:1.0:function:string-equal\">                     <Apply " +
                "FunctionId=\"urn:oasis:names:tc:xacml:1.0:function:string-one-and-only\">                        " +
                "<SubjectAttributeDesignator AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject-category:recipient" +
                "-subject\"                                                    DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\"                                                    " +
                "MustBePresent=\"false\"/>                     </Apply>                     <AttributeValue " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">1003092362</AttributeValue>                  " +
                "</Apply>               </Apply>               <Apply " +
                "FunctionId=\"urn:oasis:names:tc:xacml:1.0:function:or\">                  <Apply " +
                "FunctionId=\"urn:oasis:names:tc:xacml:1.0:function:string-equal\">                     <Apply " +
                "FunctionId=\"urn:oasis:names:tc:xacml:1.0:function:string-one-and-only\">                        " +
                ...
                "                                            DataType=\"http://www.w3.org/2001/XMLSchema#string\"    " +
                "                                                MustBePresent=\"false\"/>                     " +
                "</Apply>                     <AttributeValue DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\">TREAT</AttributeValue>                  </Apply>               " +
                "</Apply>               <Apply " +
                ...
                "                                 MustBePresent=\"false\"/>                  </Apply>                " +
                "  <AttributeValue DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#dateTime\">2017-06-19T00:00:00-0400</AttributeValue>               </Apply>  " +
                ...
                "                                 MustBePresent=\"false\"/>                  </Apply>                " +
                "  <AttributeValue DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#dateTime\">2018-06-19T00:00:00-0400</AttributeValue>               </Apply>  " +
                "          </Apply>         </Condition>      </Rule>      <Rule Effect=\"Deny\" " +
                "RuleId=\"deny-others\"/>      <Obligations>         <Obligation FulfillOn=\"Permit\"                " +
                "     ObligationId=\"urn:samhsa:names:tc:consent2share:1.0:obligation:share-sensitivity-policy-code" +
                "\">            <AttributeAssignment " +
                "AttributeId=\"urn:oasis:names:tc:xacml:3.0:example:attribute:text\"                                 " +
                "DataType=\"http://www.w3.org/2001/XMLSchema#string\">ALC</AttributeAssignment>         </Obligation>" +
                "         <Obligation FulfillOn=\"Permit\"                     " +
                "ObligationId=\"urn:samhsa:names:tc:consent2share:1.0:obligation:share-sensitivity-policy-code\">    " +
                "        <AttributeAssignment AttributeId=\"urn:oasis:names:tc:xacml:3.0:example:attribute:text\"    " +
                "                             DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\">HIV</AttributeAssignment>         </Obligation>         <Obligation " +
                "FulfillOn=\"Permit\"                     " +
                "ObligationId=\"urn:samhsa:names:tc:consent2share:1.0:obligation:share-sensitivity-policy-code\">    " +
                "        <AttributeAssignment AttributeId=\"urn:oasis:names:tc:xacml:3.0:example:attribute:text\"    " +
                "                             DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\">COM</AttributeAssignment>         </Obligation>         <Obligation " +
                "FulfillOn=\"Permit\"                     " +
                "ObligationId=\"urn:samhsa:names:tc:consent2share:1.0:obligation:share-sensitivity-policy-code\">    " +
                "        <AttributeAssignment AttributeId=\"urn:oasis:names:tc:xacml:3.0:example:attribute:text\"    " +
                "                             DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\">ETH</AttributeAssignment>         </Obligation>         <Obligation " +
                "FulfillOn=\"Permit\"                     " +
                "ObligationId=\"urn:samhsa:names:tc:consent2share:1.0:obligation:share-sensitivity-policy-code\">    " +
                "        <AttributeAssignment AttributeId=\"urn:oasis:names:tc:xacml:3.0:example:attribute:text\"    " +
                "                             DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\">SEX</AttributeAssignment>         </Obligation>         <Obligation " +
                "FulfillOn=\"Permit\"                     " +
                "ObligationId=\"urn:samhsa:names:tc:consent2share:1.0:obligation:share-sensitivity-policy-code\">    " +
                "        <AttributeAssignment AttributeId=\"urn:oasis:names:tc:xacml:3.0:example:attribute:text\"    " +
                "                             DataType=\"http://www" +
                ".w3.org/2001/XMLSchema#string\">PSY</AttributeAssignment>         </Obligation>      </Obligations> " +
                "  </Policy></PolicySet>";
